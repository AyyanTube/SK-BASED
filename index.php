		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>@ib1889</strong></h4> 
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/ib1889">CLICK HERE TO JOIN @ib1889 </a> <br>
...
Swal.fire({ title: "@ib1889", text: "Join Our Telegram Channel :)", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
