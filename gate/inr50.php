...
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_USERPWD, $sk. ':' . '');
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount=5000&currency=usd&payment_method_types[]=card&description=@ib1889 Donation&payment_method='.$tok1.'&confirm=true&off_session=true');
...
elseif(strpos($result2, "lost_card" )) {
    echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY @ib1889</span> <br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo 'DEAD</span> CC:  '.$lista.'</span>  <br>Result: SK Rate_Limit</span><br>';
